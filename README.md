...
### Where can if find the Java doc ?

Look in [Maven repository](http://central.maven.org/maven2/org/hyperledger/fabric-sdk-java/fabric-sdk-java/)
...
### Is there an API to query for all channels?
No.
