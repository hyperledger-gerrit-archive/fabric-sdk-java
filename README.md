 ...
 * Open the file `Vagrantfile` and verify that the following insert the following `config.vm.network` statements are set:
```
...
ssh into vagrant, go to $GOPATH/src/github.com/hyperledger/fabric
