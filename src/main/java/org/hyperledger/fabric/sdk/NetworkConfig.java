...
*/
        ...
        if (ca != null) {
            JsonObject registrar = getJsonValueAsObject(ca.get("registrar"));
            if (registrar != null) {
        ...
        String adminPrivateKeyPemBytes = null;

        String adminSignedCertPath = null;
        String adminSignedCertPemBytes = null;
        ...
        if (jsonKey != null) {
            ...
            adminPrivateKeyPemBytes = getJsonValueAsString(jsonKey.get("pem"));
        }
        ...
        if (jsonCert != null) {
            ...
            adminSignedCertPemBytes = getJsonValueAsString(jsonCert.get("pem"));
        }

        if (adminPrivateKeyPath != null && adminPrivateKeyPemBytes != null) {
            throw new NetworkConfigurationException(format("Organization %s should not specify both adminPrivateKey path and pem", clientOrganizationName));
        }

        if (adminSignedCertPath != null && adminSignedCertPemBytes != null) {
            throw new NetworkConfigurationException(format("Organization %s should not specify both signedCert path and pem", clientOrganizationName));
        }

        if (adminPrivateKeyPath != null) {
            // Determine full pathname and ensure the file exists
            File pemFile = new File(adminPrivateKeyPath);
            String fullPathname = pemFile.getAbsolutePath();
            if (!pemFile.exists()) {
                throw new NetworkConfigurationException(format("Organization %s: AdminPrivateKey file %s does not exist", clientOrganizationName, fullPathname));
            }
            admin.setPrivateKeyFile(fullPathname);
        }

        if (adminPrivateKeyPemBytes != null) {
            admin.setPrivateKeyPemBytes(adminPrivateKeyPemBytes);
        }


        if (adminSignedCertPath != null) {
            // Determine full pathname and ensure the file exists
            File pemFile = new File(adminSignedCertPath);
            String fullPathname = pemFile.getAbsolutePath();
            if (!pemFile.exists()) {
                throw new NetworkConfigurationException(format("Organization %s: SignedCert file %s does not exist", clientOrganizationName, fullPathname));
            }
            admin.setSignedCertFile(fullPathname);
        }

        if (adminSignedCertPemBytes != null) {
            admin.setSignedCertPemBytes(adminSignedCertPemBytes);
        }
...
*/
    ...
    public static class UserInfo {
        ...
        private String signedCertPemBytes;
        ...
        public String getPrivateKeyPemBytes() {
            return privateKeyPemBytes;
        }
        ...
        public String getSignedCertPemBytes() {
            return signedCertPemBytes;
        }
        ...
        void setPrivateKeyPemBytes(String pemBytes) {
            privateKeyPemBytes = pemBytes;
        }
        ...
        void setSignedCertPemBytes(String pemBytes) {
            signedCertPemBytes = pemBytes;
        }
    }
