...
public class NetworkConfig {
     ...
     * @throws IOException
     */
    public static NetworkConfig fromFileOLD(File configFile) throws InvalidArgumentException, IOException {
     ...
     * @throws IOException
     */
    public static NetworkConfig fromYamlFile(File configFile) throws InvalidArgumentException, IOException {
     ...
     * @throws IOException
     */
    public static NetworkConfig fromJsonFile(File configFile) throws InvalidArgumentException, IOException {
     ...
     * @throws InvalidArgumentException
     */
    public static NetworkConfig fromYamlStream(InputStream configStream) throws InvalidArgumentException, IOException {
    ...
    private static NetworkConfig fromFile(File configFile, boolean isJson) throws InvalidArgumentException, IOException {
...
*/
        ...
        if (jsonCAs != null) {
            ...
            if (ca == null) {
                throw new RuntimeException("Certificate Authority " + caName + " is not defined");
            }
        }
...
*/
    ...
    private void createAllCertificateAuthorities() {
        ...
        if (jsonCertificateAuthorities != null) {
            ...
            for (Entry<String, JsonValue> entry : jsonCertificateAuthorities.entrySet()) {
                ...
                if (jsonCA == null) {
                    throw new RuntimeException("Error loading config. Invalid CA entry: " + caName);
                }
