...
class BlockDeserializer {
    ...
    EnvelopeDeserializer getData(int index) {
        ...
        EnvelopeDeserializer envelopeDeserialize = new EnvelopeDeserializer(getData().getData(index));

        envelopes.put(index, new WeakReference<>(envelopeDeserialize));

        return envelopeDeserialize;
