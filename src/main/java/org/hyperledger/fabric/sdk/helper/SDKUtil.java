...
public final class SDKUtil {
    ...
    public static void generateTarGz(String src, String target) throws IOException {
        ...
        GzipCompressorOutputStream os = new GzipCompressorOutputStream(new BufferedOutputStream(destinationOutputStream));
        TarArchiveOutputStream archiveOutputStream = new TarArchiveOutputStream(os);
