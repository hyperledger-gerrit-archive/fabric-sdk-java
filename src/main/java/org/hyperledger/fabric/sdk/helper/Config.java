...
public class Config {
    ...
    private Config() {
        ...
        try {
            ...
            defaultProperty(SECURITY_PROVIDER_CLASS_NAME, CryptoSuiteFactory.DEFAULT_JDK_PROVIDER);
            // Could call out specific provider like Bouncy castle below.
    ...
    public String getSecurityProviderClassName() {
        return CryptoSuiteFactory.DEFAULT_JDK_PROVIDER;
    }
    ...
    public Map<Integer, String> getSecurityCurveMapping() {
        ...
        if (curveMapping == null) {
            ...
            Map<Integer, String> lcurveMapping = parseSecurityCurveMappings(getProperty(SECURITY_CURVE_MAPPING));

            curveMapping = lcurveMapping;
        }
