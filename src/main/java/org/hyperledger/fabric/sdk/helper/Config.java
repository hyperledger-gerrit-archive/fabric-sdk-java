...
public class Config {
    ...
    private static final String DEFAULT_CONFIG_FILE_PROP = "org.hyperledger.fabric.sdk.configuration";
    ...
    private Config() {
        ...
        try {
            ...
            loadFile = new File(System.getProperty(DEFAULT_CONFIG_FILE_PROP, DEFAULT_CONFIG)).getAbsoluteFile();
    ...
    public String getProperty(String property) {
        ...
        if (ret == null) {
            ret = sdkProperties.getProperty(property);
        }
        if (null == ret) {
