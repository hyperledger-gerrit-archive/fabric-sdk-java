...
public class PemParserUtil {
    ...
    static final String readfrom = "/home/rineholt/gitws/bc/fabric-049/src/github.com/hyperledger/fabric/foo/channel/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/keystore/a26e0e9033e41632261fecfe79d148029f881c48f0a04cc7ec3fb7d8820d24db_sk";
...
//    }
    ...
    public static PrivateKey bcc5() throws Exception {
        Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
        byte[] data = IOUtils.toByteArray(new FileInputStream(readfrom));
