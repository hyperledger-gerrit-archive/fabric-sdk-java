...
class TransactionActionDeserializer {
    ...
    public TransactionActionDeserializer(TransactionAction actions) {
        byteString = actions.toByteString();
    ...
    TransactionAction getTransactionAction() {
        ...
        //   ByteString payload = ret.getPayload();
        //    ByteString header = ret.getHeader();
    ...
    void getHeader() throws InvalidProtocolBufferException {

        //getTransactionAction().getHeader()

        Common.SignatureHeader signatureHeader = Common.SignatureHeader.parseFrom(getTransactionAction().getHeader());
