...
public class SDKUtils {
    ...
    public static Collection<Set<ProposalResponse>> checkProposalConsistency(Collection<ProposalResponse> proposalResponses) throws Exception {

        HashMap<String, Set<ProposalResponse>> ret = new HashMap<>();

        for (ProposalResponse proposalResponse : proposalResponses) {

//            proposalResponse.getChaincodeActionResponseReadWriteSetInfo();
//            final ProposalResponsePayloadDeserializer proposalResponsePayloadDeserializer = proposalResponse.getProposalResponsePayloadDeserializer();
