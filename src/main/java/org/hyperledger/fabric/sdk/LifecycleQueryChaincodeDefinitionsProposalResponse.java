...
public final class LifecycleQueryChaincodeDefinitionsProposalResponse extends ProposalResponse {
    ...
    /**
     * The definitions of chaincode that have been commited.
     * @return Chaincode definitions.
     * @throws ProposalException if the proposal response is invalid.
     */
    public List<Lifecycle.QueryChaincodeDefinitionsResult.ChaincodeDefinition> getChaincodeDefinitions() throws ProposalException {
        final Lifecycle.QueryChaincodeDefinitionsResult payload = getPayload();
        if (payload == null) {
            return Collections.emptyList();
        }

        final List<Lifecycle.QueryChaincodeDefinitionsResult.ChaincodeDefinition> results = payload.getChaincodeDefinitionsList();
     ...
     *
     * @return Chaincode names.
     * @throws ProposalException if the proposal response is invalid.
     */
    public Set<String> getChaincodeNames() throws ProposalException {
        return getChaincodeDefinitions().stream()
