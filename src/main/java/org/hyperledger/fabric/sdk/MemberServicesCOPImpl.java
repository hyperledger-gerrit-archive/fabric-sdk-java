...
public class MemberServicesCOPImpl implements MemberServices {
    ...
    private static final int DEFAULT_SECURITY_LEVEL = Integer.parseInt(config.getProperty("org.hyperledger.fabric.sdk.security_level"));
    private static final String DEFAULT_HASH_ALGORITHM = config.getProperty("org.hyperledger.fabric.sdk.hash_algorithm");
...
//           Waiting on COP
//            Change-Id:
//            Idceeedadf9e5a42d995feee5bdba1353b685e9f1
//            Change #:
//            3237
//
//            JsonObjectBuilder factory = Json.createObjectBuilder();
//            factory.add("request", pem);
...
//            String str = stringWriter.toString();
    ...
    private void validateEnroll(EnrollmentRequest req) {
        if (req == null) {
