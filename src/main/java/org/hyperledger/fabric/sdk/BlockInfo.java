...
//    }
    ...
    public class EnvelopeInfo {
        ...
        public EnvelopeType getType() {
            ...
            if (BlockInfo.this.isFiltered()) {
                ...
                type = filteredBlock.getType().getNumber();
    ...
    public EnvelopeInfo getEnvelopeInfo(int envelopeIndex) throws InvalidProtocolBufferException {
        ...
        try {
            ...
            if (isFiltered()) {
                ...
                switch (filteredBlock.getType().getNumber()) {
                    case Common.HeaderType.ENDORSER_TRANSACTION_VALUE:
    ...
    public class TransactionEnvelopeInfo extends EnvelopeInfo {
        ...
        public int getTransactionActionInfoCount() {
            return BlockInfo.this.isFiltered() ? filteredTx.getFilteredActionCount() : transactionDeserializer.getPayload().getTransaction().getActionsCount();
        }
        ...
        public class TransactionActionInfo {
            ...
            private final PeerEvents.FilteredAction filteredAction;
            ...
            TransactionActionInfo(PeerEvents.FilteredAction filteredAction) {
            ...
            public ChaincodeEvent getEvent() {
                if (isFiltered()) {
                    final ChaincodeEventOuterClass.ChaincodeEvent ccEvent = !filteredAction.hasCcEvent() ?
                            null : filteredAction.getCcEvent();
                    if (null == ccEvent) {
                        return null;
                    }
                    return new ChaincodeEvent(ccEvent.toByteString());
                }
        ...
        public TransactionActionInfo getTransactionActionInfo(int index) {
            return BlockInfo.this.isFiltered() ? new TransactionActionInfo(filteredTx.getFilteredAction(index))
