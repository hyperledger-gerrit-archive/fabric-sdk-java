...
class EnvelopeDeserializer {
    ...
    static EnvelopeDeserializer newInstance(ByteString byteString) throws InvalidProtocolBufferException {
     ...
     */
        ...
        switch (type) {
            case 3:
                ret = new EndorserTransactionEnvDeserializer(byteString);
                break;
            default: //just assume base properties.
                ret = new EnvelopeDeserializer(byteString);
                break;
        }
        return ret;
