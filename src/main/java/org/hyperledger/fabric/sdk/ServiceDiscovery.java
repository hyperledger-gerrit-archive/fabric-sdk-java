...
//    }
    ...
    public interface EndorsementSelection {
        SDEndorser[] endorserSelector(SDChaindcode sdChaindcode);
    }
    ...
    public static class SDLayout {
        ...
        boolean blackList(Collection<String> names) {
