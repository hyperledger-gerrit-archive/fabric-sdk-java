...
public enum IdemixRoles {
     ...
     * @return bitmask
     */
    public static int getRoleMask(MspPrincipal.MSPRole [] roles) {
        int mask = 0;
     ...
     * @return bitmask
     */
    public static int getRoleMask(IdemixRoles role) {
        return getRoleMask(new IdemixRoles[]{role});
    }
     ...
     */
    public static boolean checkRole(int bitmask, IdemixRoles searchRole) {
     ...
     * @return IdemixRole value
     */
    public static int getIdemixRoleFromMSPRole(MspPrincipal.MSPRole.MSPRoleType type) {
     ...
     * @return IdemixRole value
     */
    public static int getIdemixRoleFromMSPRole(int type) {
        switch (type) {
