...
public enum IdemixRoles {
     ...
     * @return bitmask
     */
    protected static int getRoleMask(IdemixRoles[] roles) {
        int mask = 0;
     ...
     * @return bitmask
     */
    protected static int getRoleMask(MspPrincipal.MSPRole [] roles) {
        int mask = 0;
     ...
     * @return bitmask
     */
    protected static int getRoleMask(MspPrincipal.MSPRole role) {
     ...
     */
    protected static boolean checkRole(int bitmask, IdemixRoles searchRole) {
     ...
     */
    protected static int getIdemixRoleFromMSPRole(MspPrincipal.MSPRole role) {
     ...
     * @return IdemixRole value
     */
    protected static int getIdemixRoleFromMSPRole(MspPrincipal.MSPRole.MSPRoleType type) {
     ...
     * @return IdemixRole value
     */
    protected static int getIdemixRoleFromMSPRole(int type) {
        switch (type) {
            ...
            default:
                throw new IllegalArgumentException("The provided role is not valid");
        }
    }
     ...
     * @return MSPRole
     */
    protected static MspPrincipal.MSPRole.MSPRoleType getMSPRoleFromIdemixRole(int role) {
        ...
        throw new IllegalArgumentException("The provided role value is not valid");
    }
}