...
public class IdemixSigningIdentity implements SigningIdentity {
     ...
     */
    public IdemixSigningIdentity(IdemixIssuerPublicKey ipk, PublicKey revocationPk, String mspId, BIG sk, IdemixCredential cred, Idemix.CredentialRevocationInformation cri)
            throws CryptoException, InvalidArgumentException {
        this(ipk, revocationPk, mspId, sk, cred, cri, null, null);
    }
    ...
    public IdemixSigningIdentity(IdemixIssuerPublicKey ipk, PublicKey revocationPk, String mspId, BIG sk, IdemixCredential cred, Idemix.CredentialRevocationInformation cri,
        ...
        // input checks
        if ((ipk == null) || (revocationPk == null) || (mspId == null) || (mspId.isEmpty()) || (sk == null) || (cred == null) || (cri == null)
