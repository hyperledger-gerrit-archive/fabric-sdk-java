...
import org.hyperledger.fabric.sdk.idemix.IdemixNymSignature;
...
public class IdemixSigningIdentity implements SigningIdentity {
     ...
     */
    public IdemixSigningIdentity(IssuerPublicKey ipk, String mspId, BIG sk, IdemixCredential cred) throws CryptoException {
        this(ipk, mspId, sk, cred, null, null, IdemixUtils.getRand());
    }
     ...
     * @throws CryptoException
     */
    public IdemixSigningIdentity(IssuerPublicKey ipk, String mspId, BIG sk, IdemixCredential cred, IdemixPseudonym pseudonym, IdemixSignature proof) throws CryptoException {
        this(ipk, mspId, sk, cred, pseudonym, proof, IdemixUtils.getRand());
    }
     ...
     */
    public IdemixSigningIdentity(IssuerPublicKey ipk, String mspId, BIG sk, IdemixCredential cred, IdemixPseudonym pseudonym, IdemixSignature proof, RAND rng) throws CryptoException {
        // input checks
        ...
        if (pseudonym == null && proof == null) {
            ...
            this.pseudonym = new IdemixPseudonym(this.sk, this.ipk, rng);

            // generate a fresh proof of possession of a credential
            // with respect to a freshly generated pseudonym
            this.proof = new IdemixSignature(this.cred, this.sk, this.pseudonym.getNym(), this.pseudonym.getRandNym(), this.ipk, this.disclosedFlags, this.msg, this.rng);
        } else {
    ...
    public byte[] sign(byte[] msg) throws CryptoException {
        ...
        return new IdemixNymSignature(sk, pseudonym.getNym(), pseudonym.getRandNym(), ipk, msg, rng).toProto().toByteArray();
    }
    ...
    public boolean verifySignature(byte[] msg, byte[] sig) throws CryptoException {
        ...
        IdemixNymSignature nymSig = new IdemixNymSignature(nymSigProto);
