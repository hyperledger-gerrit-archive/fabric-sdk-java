...
public class IdemixSigningIdentity implements SigningIdentity {
    ...
    // OU attribute as a String
    private String ouValue;

    // role attribute as boolean
    ...
    public IdemixSigningIdentity(IdemixIssuerPublicKey ipk, PublicKey revocationPk, String mspId, BIG sk, IdemixCredential cred, Idemix.CredentialRevocationInformation cri, String ou, boolean role)
        ...
        this(ipk, revocationPk, mspId, sk, cred, cri, ou, role, null, null);
    }
     ...
     */
    public IdemixSigningIdentity(IdemixIssuerPublicKey ipk, PublicKey revocationPk, String mspId, BIG sk, IdemixCredential cred,
            Idemix.CredentialRevocationInformation cri, String ou, boolean role, IdemixPseudonym pseudonym, IdemixSignature proof)
                    throws CryptoException, InvalidArgumentException {
        // input checks
        ...
        this.idemixIdentity = new IdemixIdentity(mspId, this.pseudonym.getNym(), ouValue, roleValue,
                this.proof);
    }
