...
public class Peer implements Serializable {
    ...
    void initiateEventing(TransactionContext transactionContext) throws TransactionException {
        ...
        if (peerEventingClient == null) {
            ...
            peerEventingClient = new PeerEventServiceClient(this, new Endpoint(url, properties).getChannelBuilder(), properties);
    ...
    public void reconnectPeerEventServiceClient(final PeerEventServiceClient failedPeerEventServiceClient, final Throwable t) {
        if (shutdown) {
        ...
        if (executorService != null && !executorService.isShutdown() && !executorService.isTerminated()) {
            ...
            executorService.execute(() -> {
                ...
                PeerEventServiceClient lpeerEventingClient = new PeerEventServiceClient(this, new Endpoint(url, properties).getChannelBuilder(), properties);
