...
public class Peer {
    ...
    public Peer(String url, String pem) throws InvalidArgumentException {
        ...
        PeerClient peerClient = new PeerClient(new Endpoint(url, pem).getChannelBuilder());
    ...
    public ProposalResponse sendProposal(FabricProposal.Proposal proposal) throws PeerException, InvalidArgumentException {
        if(proposal == null){
        ...
        FabricProposalResponse.ProposalResponse fabricResponse = endorserClent.sendProposal(proposal);

        ProposalResponse proposalResponse = new ProposalResponse("3", fabricResponse.getResponse().getStatus(), fabricResponse.getResponse().getMessage());
        proposalResponse.setProposalResponse(fabricResponse);
        proposalResponse.setProposal(proposal);
        proposalResponse.setPeer(this);
