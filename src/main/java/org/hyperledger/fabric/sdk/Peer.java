...
public class Peer implements Serializable {
    ...
    private static final String BP = "org.hyperledger.fabric.sdk.peer.";
    ...
    Peer(String name, String grpcURL, Properties properties) throws InvalidArgumentException {
        ...
        if (null != properties) {
            String role = properties.getProperty(BP + "roles");
            ...
            role = properties.getProperty(BP + "remove_roles");
...
//        //  properties.put(BP + ".role", "ENDORSING_PEER:CHAINCODE_QUERY");
//        properties.put(BP + ".remove_role", "ENDORSING_PEER:CHAINCODE_QUERY");
//
//        Peer p = new Peer("blah", "grpc://localhost:80", properties);
//
//        System.out.println(p.hasRole(PeerRole.ENDORSING_PEER));
//        System.out.println(p.hasRole(PeerRole.EVENT_SOURCE));
//        System.out.println(p.hasRole(PeerRole.CHAINCODE_QUERY));
//
//    }
