...
*/
     ...
     */
    public ChainCodeResponse deploy(DeployRequest deployRequest) throws ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
     ...
     */
    public ChainCodeResponse invoke(InvokeRequest invokeRequest) throws ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
     ...
     * @throws ChainCodeException
     */
    public ChainCodeResponse query(QueryRequest queryRequest) throws ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
   ...
   public void setAttrs(List<String> attrs) {
    ...
    private Fabric.Response execute(Transaction tx) throws CryptoException, IOException {
        ...
        if (tx.getTxBuilder().getConfidentialityLevel() == Chaincode.ConfidentialityLevel.CONFIDENTIAL &&
            ...
            Fabric.Response response = this.getChain().sendTransaction(tx.getTxBuilder().build());
            ...
            return this.getChain().sendTransaction(tx.getTxBuilder().build());
        }
    }
