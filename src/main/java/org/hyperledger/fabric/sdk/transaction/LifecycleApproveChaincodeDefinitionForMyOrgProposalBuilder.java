...
public class LifecycleApproveChaincodeDefinitionForMyOrgProposalBuilder extends LifecycleProposalBuilder {
    ...
    protected LifecycleApproveChaincodeDefinitionForMyOrgProposalBuilder() {
        ...
        builder.setSource(Lifecycle.ChaincodeSource.newBuilder()
                .setUnavailable(Lifecycle.ChaincodeSource.None.newBuilder().build()).build());
    ...
    public void setHash(byte[] hash) {
        ...
        builder.setSource(Lifecycle.ChaincodeSource.newBuilder()
                .setLocalPackage(Lifecycle.ChaincodeSource.Local.newBuilder().setHash(ByteString.copyFrom(hash)).build()));
    }
    ...
    public void setValidationParamter(byte[] endorsementPolicy) {
        builder.setValidationParameter(ByteString.copyFrom(endorsementPolicy));
    }
