...
public interface CryptoSuite {
    ...
    /**
     * @return the {@link java.util.Properties) object containing implementation specific signing properties
     */
    public Properties getSigningProperties();
    /**
     * Pass in implementation specific properties to the CryptoSuite
     * @param verifyProperties A {@link java.util.Properties} object. The key/value pairs are implementation specific
     */
     ...
     * @throws CryptoException
     */
    public byte[] hash(byte[] plainText) throws CryptoException ;
