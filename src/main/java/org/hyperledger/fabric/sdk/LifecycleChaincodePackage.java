...
public class LifecycleChaincodePackage {
     ...
     * @throws IOException
     */
    public static LifecycleChaincodePackage fromFile(File policyFile) throws IOException {
    ...
    public static LifecycleChaincodePackage fromStream(InputStream inputStream) throws IOException {
     ...
     */
    public static LifecycleChaincodePackage fromBytes(byte[] packageBytes) {
    ...
    public static LifecycleChaincodePackage fromSource(Path chaincodeSource, TransactionRequest.Type chaincodeType, String chaincodePath, Path chaincodeMetaInfLocation) throws IOException {
    ...
    static byte[] generatePackageMataDataBytes(String path, TransactionRequest.Type type) {
