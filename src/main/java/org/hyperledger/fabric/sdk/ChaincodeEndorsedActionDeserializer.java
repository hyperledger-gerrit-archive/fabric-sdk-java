...
class ChaincodeEndorsedActionDeserializer {
    ...
    private WeakReference<ProposalResponsePayloadDeserializer> channelHeader;
    ...
    ChaincodeEndorsedAction getChaincodeEndorsedAction() {
        ...
        //TODO Endorsements
//        FabricProposalResponse.Endorsement endorsements = ret.getEndorsements(0);
//        endorsements.
    ...
    byte[] getEndorsementSingnature(int index){
