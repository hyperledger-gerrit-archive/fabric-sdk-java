...
public class IdemixNymSignature {
     ...
     */
    public IdemixNymSignature(BIG sk, IdemixPseudonym pseudonym, IdemixIssuerPublicKey ipk, byte[] msg) {
     ...
     *
     * @param proto a protobuf object representing a NymSignature
     */
     ...
     */
    public boolean ver(ECP nym, IdemixIssuerPublicKey ipk, byte[] msg) {
    ...
    /**
     * @return A proto object representing this NymSignature
     */
