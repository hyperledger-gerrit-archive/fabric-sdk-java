 ...
 */
public interface NonRevocationProver {
    ...
    static NonRevocationProver getNonRevocationProver(RevocationAlgorithm algorithm) {
        switch (algorithm) {
            ...
            default:
                ...
                throw new IllegalArgumentException("Revocation algorithm not supported");
        }
    }
    ...
    /**
     * getNonRevokedProof performs the second round of a two-round zero-knowledge proof,
     * proving that a credential with some revocation handle is not revoked.
     *
     * @param challenge Fiat-Shamir challenge of the zero-knowledge proof
     * @return proof
     */
    Idemix.NonRevocationProof getNonRevokedProof(BIG challenge);
