...
import static org.hyperledger.fabric.sdk.idemix.IdemixUtils.rng;
...
public class IdemixCredential {
    ...
    public IdemixCredential(IdemixIssuerKey key, IdemixCredRequest m, BIG[] attrs) {
        ...
        E = IdemixUtils.randModOrder();
        S = IdemixUtils.randModOrder();
    ...
    /**
     * Construct a IdemixCredRequest from a serialized credential
     */
     ...
     */
    public boolean ver(BIG sk, IdemixIssuerPublicKey ipk) {
