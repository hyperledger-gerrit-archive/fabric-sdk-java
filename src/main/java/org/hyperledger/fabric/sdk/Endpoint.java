...
class Endpoint {
    ...
    Endpoint(String url, Properties properties) {
        ...
        if (properties != null) {
            ...
            final Pair<PrivateKey, X509Certificate[]> clientTLSProps = getClientTLSProps(properties);
    ...
    Pair<PrivateKey, X509Certificate[]> getClientTLSProps(Properties properties) {
