...
class Endpoint {
    ...
    static final String REMAP2HOST = System.getProperty("org.hyperledger.fabric.sdk.test.endpoint_remap_host_name");
    ...
    static Endpoint createEndpoint(String url, Properties properties) {
        ...
        if (REMAP2HOST != null && !REMAP2HOST.isEmpty()) {
            ...
            int port = Integer.parseInt(purl.getProperty("port"));
            url = protocol + "://" + REMAP2HOST + ":" + port;
