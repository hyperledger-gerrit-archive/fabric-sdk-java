...
//    };
     ...
     * @throws ProposalException
     */
    public Collection<ProposalResponse> sendTransactionProposalToEndorsers(TransactionProposalRequest transactionProposalRequest, User userContext) throws ProposalException, InvalidArgumentException, ServiceDiscoveryException {
        ...
        if (sdChaindcode.blackList(Arrays.asList("rick")) < 1) { // apply a blackist.
            throw new ServiceDiscoveryException("Applying blacklist reduced to no available endorser options.");
        }

        ServiceDiscovery.SDEndorser[] ep = endorsementSelection.endorserSelector(sdChaindcode);
