...
//    };
    ...
    public Collection<ProposalResponse> sendTransactionProposalToEndorsers(TransactionProposalRequest transactionProposalRequest, DiscoveryOptions discoveryOptions) throws ProposalException, InvalidArgumentException, ServiceDiscoveryException {
        ...
        try {
            ...
            final Map<String, ProposalResponse> goodResponses = new HashMap<>();
            final Map<String, ProposalResponse> allTried = new HashMap<>();

            boolean done = false;
            int attempts = 0; //safety valve
            ...
            do {
                ...
                if (ep == null || ep.isEmpty()) {
                    if (inspectResults) {
                        ...
                        throw new ServiceDiscoveryException(format("Could not meet endorsement polices for chaincode %s", chaincodeName));
                    }
                }
                ...
                if (ep.isEmpty()) { // this would be odd but let go with it.
                    return goodResponses.values();
                }
                ...
                if (needed != null) {
                    ...
                    if (sdChaindcodeNI.ignoreList(theTried) < 1) { // apply ignore list
                        done = true;
                    }
            ...
            if (inspectResults) {
                ...
                throw new ServiceDiscoveryException(format("Could not meet endorsement police for chaincode %s", chaincodeName));
            }
        } catch (ProposalException e) {
            throw e;
