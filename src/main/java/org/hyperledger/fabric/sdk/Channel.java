...
//    private Set<Anchor> anchorPeers;
    ...
    private Channel(String name, HFClient hfClient, Orderer orderer, ChannelConfiguration channelConfiguration, byte[][] signers) throws InvalidArgumentException, TransactionException {
        ...
        try {
            ...
            sendUpgradeChannel(channelConfiguration, signers, orderer);
    ...
    /**
     * Upgrade channel with specified channel configuration
     *
    ...
    public void upgradeChannelConfiguration(ChannelConfiguration channelConfiguration, byte[][] signers) throws TransactionException, InvalidArgumentException {

        upgradeChannelConfiguration(channelConfiguration, signers, getRandomOrderer());
    ...
    public void upgradeChannelConfiguration(ChannelConfiguration channelConfiguration, byte[][] signers, Orderer orderer) throws TransactionException, InvalidArgumentException {
        ...
        try {
            ...
            do {
                ...
                if (currentLastConfigIndex == startLastConfigIndex) {
                    ...
                    final long duration = TimeUnit.MICROSECONDS.convert(System.nanoTime() - nanoTimeStart, TimeUnit.NANOSECONDS);
                    ...
                    if (duration > CHANNEL_CONFIG_WAIT_TIME) {
                        ...
                        try {
                            ...
                            TransactionException te = new TransactionException("upgrade thread Sleep", e);
    ...
    private void sendUpgradeChannel(ChannelConfiguration channelConfiguration, byte[][] signers, Orderer orderer) throws TransactionException, InvalidArgumentException {

        logger.debug(format("Channel %s sendUpgradeChannel", name));
        checkOrderer(orderer);
        ...
        try {
            ...
            do {
                ...
                logger.debug(format("Channel %s sendUpgradeChannel %d", name, statusCode));
                if (statusCode == 404 || statusCode == 503) {
                    ...
                    if (duration > CHANNEL_CONFIG_WAIT_TIME) {
                        ...
                        throw new TransactionException(format("Channel update error timed out after %d ms.  %s error. StatusValue %d. Status %s", name,
                                duration, statusCode, "" + trxResult.getStatus()));
                    }
