...
public class Channel implements Serializable {
    ...
    public AnchorPeersConfigUpdateResult getConfigUpdateAnchorPeers(Peer peer, User userContext, Collection<String> peersToAdd, Collection<String> peersToRemove) throws Exception {
        ...
        // Block ub = Block.parseFrom(configBlock.toByteArray());
        //Bloc = configBlock.toBuilder();
        ...
        //configBuilderUpdate.getChannelGroup();
        ...
        ConfigGroup org1MSP1 = application.getGroupsMap().get(mspid);
        ...
        ConfigGroup.Builder org1MSP = org1MSP1.toBuilder();

        String modPolicy = org1MSP1.getModPolicy() != null ? org1MSP1.getModPolicy() : "Admins";

        Map<String, ConfigValue> valuesMap = org1MSP.getValuesMap();

        ConfigValue anchorPeers1 = valuesMap.get("AnchorPeers");

        final Set<String> currentAP = new HashSet<>(36);

        if (null != anchorPeers1 && anchorPeers1.getValue() != null) {
            modPolicy = anchorPeers1.getModPolicy() != null ? "Admins" : modPolicy;

            Configuration.AnchorPeers anchorPeers = Configuration.AnchorPeers.parseFrom(anchorPeers1.getValue());
...
//       }
        ConfigGroup build = org1MSP.putAllValues(m).build();
