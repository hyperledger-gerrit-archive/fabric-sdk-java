...
//       }
     ...
     *
     * @param queryChaincodeDefinitionsRequest the request.
    ...
    public Collection<LifecycleQueryChaincodeDefinitionsProposalResponse> lifecycleQueryChaincodeDefinitions(LifecycleQueryChaincodeDefinitionsRequest queryChaincodeDefinitionsRequest, Collection<Peer> peers) throws InvalidArgumentException, ProposalException {
        if (null == queryChaincodeDefinitionsRequest) {
            throw new NullPointerException("The queryChaincodeDefinitionsRequest parameter can not be null.");
        }
        checkChannelState();
        checkPeers(peers);
        ...
        try {
            ...
            TransactionContext context = getTransactionContext(queryChaincodeDefinitionsRequest);
            LifecycleQueryChaincodeDefinitionsBuilder q = LifecycleQueryChaincodeDefinitionsBuilder.newBuilder();
            q.context(context);
            SignedProposal qProposal = getSignedProposal(context, q.build());

            return sendProposalToPeers(peers, qProposal, context, LifecycleQueryChaincodeDefinitionsProposalResponse.class);
        } catch (Exception e) {
