...
//
    ...
    public Channel addOrderer(Orderer orderer) throws InvalidArgumentException {
        ...
        logger.debug(format("Channel %s adding orderer: %s, url: %s", toString(), orderer.getName(), orderer.getUrl()));
    ...
    public Channel initialize() throws InvalidArgumentException, TransactionException {
        ...
        try {
            ...
            logger.info(format("Channel %s eventThread started shutdown: %b  thread: %s ", name, shutdown, eventQueueThread == null ? "null" : eventQueueThread.getName()));
