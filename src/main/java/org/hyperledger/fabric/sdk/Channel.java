...
public class Channel implements Serializable {
    ...
    transient volatile long lastChaincodeUpgradeEventBlock;
    ...
    public Channel initialize() throws InvalidArgumentException, TransactionException {
        ...
        try {
            ...
            if (serviceDiscovery != null) {
                chaincodeEventUpgradeListenerHandle = registerChaincodeEventListener(Pattern.compile(".*"), Pattern.compile("^upgrade$"), (handle, blockEvent, chaincodeEvent) -> {
