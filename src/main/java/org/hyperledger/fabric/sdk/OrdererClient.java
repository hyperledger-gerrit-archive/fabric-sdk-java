...
public class OrdererClient {
    ...
    public Ab.BroadcastResponse sendTransaction(Envelope envelope) {
        ...
        //TODO: see how to get rid of array when we only need a variable that can be modified in inner class
        ...
        StreamObserver<Envelope> nso = broadcast.broadcast(so);
        nso.onNext(envelope);
        //nso.onCompleted();
