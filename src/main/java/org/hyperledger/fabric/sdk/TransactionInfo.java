...
public class TransactionInfo {
    ...
    TransactionInfo(String txID, ProcessedTransaction processedTransaction) {
        ...
        this.txEnvelope = processedTransaction.getTransactionEnvelope();
        this.validationCode = processedTransaction.getValidationCode();
    ...
    public TxValidationCode getValidationCode() {
        return TxValidationCode.forNumber(validationCode);
    }
