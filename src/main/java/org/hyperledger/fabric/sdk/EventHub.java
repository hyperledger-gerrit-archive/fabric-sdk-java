...
public class EventHub {
     ...
     *   pemFile - File location for x509 pem certificate for SSL.</br>
     *   certificateOverride - boolen(true/false) override CN to match certificate -- for development only.</br>
     *   overrideAuthority - Specify the certificates CN -- for development only.
     *
