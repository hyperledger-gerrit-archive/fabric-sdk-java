...
class ChaincodeProposalPayloadDeserializer {
    ...
    ChaincodeProposalPayloadDeserializer(TransactionAction actions) {
    ...
    ChaincodeProposalPayload getChaincodeProposalPayload() {
        ...
        //ret.getInput(); //Chaincode.ChaincodeInput cinput = Chaincode.ChaincodeInput.parseFrom(ccpp.getInput());
