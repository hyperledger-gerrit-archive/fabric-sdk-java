...
public class HFCAClient implements MemberServices {
    ...
    public Enrollment enroll(String user, String secret) throws EnrollmentException, InvalidArgumentException {
        ...
        try {
            ...
            signingKeyPair = cryptoPrimitives.keyGen();
        ...
        return enroll (user, secret, signingKeyPair);
    }

    /**
     * Enroll the user with member service
     *
     * @param user Enrollment request with the following fields: name, enrollmentSecret, keyPair
     * @return enrollment
     */
    @Override
    public Enrollment enroll(String user, String secret, KeyPair keypair) throws EnrollmentException, InvalidArgumentException {

        logger.debug(format("enroll user %s with keypair", user));
        ...
        try {
            ...
            // build request body
            EnrollmentRequest req = new EnrollmentRequest(user, pem);
            String body = req.toJson();
    ...
    public Enrollment reenroll(User user) throws EnrollmentException, InvalidArgumentException {
        ...
        try {
            ...
            // build request body
            EnrollmentRequest req = new EnrollmentRequest(user.getName(), pem);
            String body = req.toJson();
