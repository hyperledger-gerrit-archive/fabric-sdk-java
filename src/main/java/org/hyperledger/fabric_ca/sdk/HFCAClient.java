...
public class HFCAClient {
    ...
    public HFCAInfo info() throws InfoException, InvalidArgumentException {
        ...
        try {
            ...
            return new HFCAInfo(caName, caChain, version, issuerPublicKey);
    ...
    public IdemixUser getIdemixUser(Enrollment enrollment, String userID, String mspID) throws EnrollmentException, InvalidArgumentException {
        ...
        try {
            ...
            HFCAInfo info = this.info();
            String ipkStr = info.getIssuerPublicKey();
            byte[] ipkBytes = Base64.getDecoder().decode(ipkStr.getBytes());
            ...
            // Deserialize response and return IdemixUser
            ...
            return new IdemixUser(userID, mspID, ipk, cred, sk);
        } catch (EnrollmentException ee) {
            logger.error(ee.getMessage(), ee);
            throw ee;
        } catch (Exception e) {
