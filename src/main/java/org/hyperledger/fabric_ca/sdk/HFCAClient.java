...
public class HFCAClient {
    ...
    /**
     * getIdemixSigningIdentity returns a signing identity
     *
    ...
    public IdemixUser getIdemixSigningIdentity(Enrollment enrollment, String userID, String mspID) throws EnrollmentException, InvalidArgumentException {
        if (cryptoSuite == null) {
            throw new InvalidArgumentException("Crypto primitives not set");
        }
