...
public class HFCAInfo {
    ...
    private final String issuerRevocationPublicKey;
    ...
    HFCAInfo(String caName, String caChain, String version) {
        ...
        this.issuerRevocationPublicKey = "";
    }
     ...
     * this version of idemix.
     */
    public String getIssuerRevocationPublicKey() { return issuerRevocationPublicKey; }
