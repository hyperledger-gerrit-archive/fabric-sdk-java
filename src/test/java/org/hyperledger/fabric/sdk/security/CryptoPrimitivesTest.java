...
public class CryptoPrimitivesTest {
    ...
    public void testGetSetProperties() {
        ...
        assertEquals(Integer.parseInt(cryptoProps.getProperty(Config.MAC_KEY_BYTE_COUNT)), config.getMACKeyByteCount());
        Properties propsIn = new Properties();
        propsIn.setProperty(Config.MAC_KEY_BYTE_COUNT, "1111");
        testCrypto.setProperties(propsIn);
        cryptoProps = testCrypto.getProperties();
        assertEquals(cryptoProps.getProperty(Config.HASH_ALGORITHM), hashAlg);
        assertEquals(cryptoProps.getProperty(Config.MAC_KEY_BYTE_COUNT), "1111");
