...
//    }
    ...
    public void testProposalBuilderWithMetaInf() throws Exception {
        ...
        assertArrayListEquals("Tar in Install Proposal's codepage does not have expected entries. ", expect, arrayList);
    }
    ...
    public void testProposalBuilderWithMetaInfEmpty() throws Exception {
        ...
        thrown.expect(java.lang.IllegalArgumentException.class);
        thrown.expectMessage("The META-INF directory /home/rineholt/gitws/bc/fsj-1392/fabric-sdk-java/src/test/fixture/meta-infs/emptyMetaInf/META-INF is empty.");
