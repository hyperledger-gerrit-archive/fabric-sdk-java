...
//    }
    ...
    class MockEndorserClient extends EndorserClient {
        final Throwable t;
        private final ListenableFuture<FabricProposalResponse.ProposalResponse> f;

        MockEndorserClient(Throwable t) {
            super(new Endpoint("grpc://loclhost:99", null).getChannelBuilder());
            this.t = t;
            this.f = null;
        }

        MockEndorserClient(ListenableFuture<FabricProposalResponse.ProposalResponse> f) {
            super(new Endpoint("grpc://loclhost:99", null).getChannelBuilder());
            this.t = null;
            this.f = f;
        }
