...
//    }
    ...
    public void testNOf() throws Exception {
        ...
        //One from each set.
        NOfEvents nOfEvents = NOfEvents.create().addNOfs(NOfEvents.create().setN(1).addPeers(peer1Org1, peer1Org12nd),
                NOfEvents.create().setN(1).addPeers(peer2Org2, peer2Org22nd)
        );
        ...
        nOfEvents = NOfEvents.create().addNOfs(NOfEvents.create().addPeers(peer1Org1, peer1Org12nd),
                NOfEvents.create().addPeers(peer2Org2, peer2Org22nd)
        );
        ...
        nOfEvents = NOfEvents.create().setN(1).addNOfs(NOfEvents.create().addPeers(peer1Org1, peer1Org12nd),
                NOfEvents.create().addEventHubs(peer2Org2eh, peer2Org22ndeh)
        );
