...
import org.hyperledger.fabric.sdk.exception.CreateTransactionFailedException;
...
public class PeerClientTest {
	...
	public static void setupChain() {
		...
		} catch(CertificateException | RegistrationException | EnrollmentException | ChainCodeException | NoAvailableTCertException | InterruptedException | CryptoException | IOException | CreateTransactionFailedException cex) {
			cex.printStackTrace();// TODO: Handle the exception properly
		}
	}


	public static ChainCodeResponse deploy() throws RegistrationException, EnrollmentException, ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
	...
	public static ChainCodeResponse deployJava() throws RegistrationException, EnrollmentException, ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
		DeployRequest request = new DeployRequest();
	...
	@Test
	public void testQuery() throws RegistrationException, EnrollmentException, ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
	...
	@Test
	public void testInvoke() throws RegistrationException, EnrollmentException, ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
	...
	@Test
	public void testQueryJava() throws RegistrationException, EnrollmentException, ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
		testInvokeJava();
		QueryRequest request = new QueryRequest();
		request.setArgs(new ArrayList<>(Arrays.asList("query", "a")));
	...
	@Test
	public void testInvokeJava() throws RegistrationException, EnrollmentException, ChainCodeException, NoAvailableTCertException, CryptoException, IOException, CreateTransactionFailedException {
		InvokeRequest request = new InvokeRequest();
		request.setArgs(new ArrayList<>(Arrays.asList("invoke", "a", "b", "200")));
		request.setChaincodeID(javaDeployResponse.getChainCodeID());
		request.setChaincodeName(javaDeployResponse.getChainCodeID());
