...
public class NetworkConfigTest {
    ...
    @Test
    public void testGetClientOrgName() throws Exception {

        JsonObject jsonConfig = getJsonConfig1(1, 0, 0);

        NetworkConfig config = NetworkConfig.fromJsonObject(jsonConfig);

        System.out.println("org name = " + config.getClientOrganizationName());

        Assert.assertEquals(CLIENT_ORG_NAME, config.getClientOrganizationName());
    }
