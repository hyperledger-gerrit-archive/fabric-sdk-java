...
public class UserTest {
    ...
    public void init() throws MalformedURLException {
        ...
        try {
            ...
            User registrar = testChain.getMember("admin");
    ...
    public void testIsRegister() {
        User user = testChain.getMember("testuser02");
        ...
        user = testChain.getMember("admin");
        Assert.assertTrue(user.isRegistered());
    }

    @Test
    public void testEnroll() {
        User user = testChain.getMember("testUser2");
    ...
    public void testIsEnrolled() {
        User user = testChain.getMember("testUser3");
