...
public class ServiceDiscoveryTest {
    ...
    public void simpleOneEach() throws Exception {
        ...
        assertTrue(sdLayout.toString().contains("localhost"));
        assertTrue(sdLayout.toString().contains("otherhost"));
    ...
    public void simpleOneTwoEach() throws Exception {
        ...
        assertTrue(sdLayout.toString().contains("localhost"));
        assertTrue(sdLayout.toString().contains("otherhost:90"));
        assertTrue(sdLayout.toString().contains("otherhost:91"));
    ...
    public void simpleTwoTwoEach() throws Exception {
        ...
        assertTrue(sdLayout.toString().contains("localhost:80"));
        assertTrue(sdLayout.toString().contains("localhost:81"));
        assertTrue(sdLayout.toString().contains("otherhost:90"));
        assertTrue(sdLayout.toString().contains("otherhost:91"));
    ...
    public void simpleTwoTwoEachExtras() throws Exception {
        ...
        assertEquals(sortByEndpoint(sdEndorsers, "localhost").size(), 2);
        assertEquals(sortByEndpoint(sdEndorsers, "otherhost").size(), 2);
    ...
    public void simpleTwoTwoEachExtrasCommon() throws Exception {
        ...
        assertEquals(sortByEndpoint(sdEndorsers, "localhost").size(), 1);
        assertEquals(sortByEndpoint(sdEndorsers, "otherhost").size(), 1);
        assertEquals(sortByEndpoint(sdEndorsers, "commonHost").size(), 1);
    ...
    public void twoLayoutTwoTwoEachExtrasCommon() throws Exception {
        ...
        assertEquals(sortByEndpoint(sdEndorsers, "l2localhost").size(), 1);
        assertEquals(sortByEndpoint(sdEndorsers, "l2otherhost").size(), 1);
        assertEquals(sortByEndpoint(sdEndorsers, "l2commonHost").size(), 1);

    }

    public static class MockSDEndorser extends SDEndorser {
    ...
    private static List<SDEndorser> sortByEndpoint(Collection<SDEndorser> sdEndorsers, final String needle) {
