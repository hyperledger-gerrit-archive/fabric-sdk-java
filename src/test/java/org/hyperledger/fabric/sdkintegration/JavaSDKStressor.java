...
//            }
    ...
    //CHECKSTYLE.OFF: Method length is 320 lines (max allowed is 150).
    CompletableFuture<Boolean> installInstantiateChaincode(HFClient client, Channel channel, String chaincodeName, User installingUser) {
    ...
    CompletableFuture<Boolean> moveAmountAndExpect(HFClient client, User user, Channel channel, String chaincodeName, String moveAmount, String expect) {
