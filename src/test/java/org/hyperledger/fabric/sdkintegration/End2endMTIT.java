...
public class End2endMTIT {
    ...
    private static final int WORKER_COUNT = 50; // threads running through the code. Can not pass 399!!!
    ...
    private static final int MINUTES_TO_RUN = 30; // Minutes to run code.
