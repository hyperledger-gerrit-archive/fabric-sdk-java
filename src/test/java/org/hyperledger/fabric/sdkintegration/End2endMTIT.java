...
public class End2endMTIT {
    ...
    private static int USERS_PER_ORG = 1; // how many users per org is running through the code.
    private static int PERCENTAGE_IDEMIX_USERS = 100; //0= no IdemixUsers are used  100 = all idemixusers are used.
...
//        private SampleOrg sampleOrg;
        ...
        public void run() {
            ...
            for (int i = 0; i < 200000000; ++i) {
                ...
                int idemixUserPercent = Integer.min(Integer.max(100, PERCENTAGE_IDEMIX_USERS), 0);
...
//    }
    ...
    static class AppUser {
        ...
        public AppUser(User x509, User idemix) {
            this.x509 = x509;
            this.idemix = idemix;
        }
