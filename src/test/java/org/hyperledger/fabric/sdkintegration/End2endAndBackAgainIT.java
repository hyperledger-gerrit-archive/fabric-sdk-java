...
//                    }
    ...
    private Channel reconstructChannel(String name, HFClient client, SampleOrg sampleOrg) throws Exception {
        ...
        Peer aPeer = newChannel.getPeers().iterator().next();
        ...
        newChannel.addPeer(aPeer, PeerOptions.create().setPeerRoles(EnumSet.of(PeerRole.EVENT_SOURCE, PeerRole.LEDGER_QUERY)).startEvents(0));
