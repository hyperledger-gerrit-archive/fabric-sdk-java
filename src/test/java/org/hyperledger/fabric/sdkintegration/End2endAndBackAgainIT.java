...
//            //SampleUser can be any implementation that implements org.hyperledger.fabric.sdk.User Interface
            ...
            if (!testConfig.isRunningAgainstFabric10()) { //Peer eventing service support started with v1.1
                ...
                //Now do it again starting at block 1 and use filtered blocks.
                replayChannel = client.deSerializeChannel(replayChannelBytes);
                out("doing testPeerServiceEventingReplay,1,-1,false");
                testPeerServiceEventingReplay(client, replayChannel, 1L, -1L, true);
...
//                    }
    ...
    void testPeerServiceEventingReplay(HFClient client, Channel replayTestChannel, final long start, final long stop,
                                       final boolean useFilteredBlocks) throws InvalidArgumentException, TransactionException, InterruptedException, ExecutionException, TimeoutException, ProposalException {
        ...
        try {
            ...
            // if (useFilteredBlocks) { // lets see if filtered blocks give back expected info.
...
//                for (BlockEvent.TransactionEvent te : blockEvent.getTransactionEvents()) {
//                    int transactionActionsCounts = 0;
//                    assertTrue(te.isValid());
//                    ++transactionEventCounts;
//                    for (BlockInfo.TransactionEnvelopeInfo.TransactionActionInfo ta : te.getTransactionActionInfos()) {
//                        ++transactionActionsCounts;
//                        out("\nTA:", ta + "\n\n");
//
//                    }
//                    assertTrue(transactionActionsCounts > 0); // must have had some transactions.
//
//                }
//
//            }
//            assertTrue(transactionEventCounts > 0); // must have had some transactions.
