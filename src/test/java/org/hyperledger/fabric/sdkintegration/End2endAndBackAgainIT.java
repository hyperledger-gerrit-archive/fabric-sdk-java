    ...
    void runChain(HFClient client, Chain chain, SampleOrg sampleOrg, final int delta) {
        ...
        try {
            moveAmount(client, chain, chainCodeID, "25").thenApply(transactionEvent -> {
                ...
                try {
                    return chain.sendTransaction(successful, chain.getOrderers()).get(12000, TimeUnit.SECONDS);
                } catch (Exception e) {
                ...
                try {
                    waitOnFabric(10000);
                    out("transaction event %s", transactionEvent + "");
                    ...
                    return moveAmount(client, chain, chainCodeID_11, "50").get(12000, TimeUnit.SECONDS); // really move 100
                } catch (CompletionException e) {
                    throw e;
                } catch (Exception e) {
