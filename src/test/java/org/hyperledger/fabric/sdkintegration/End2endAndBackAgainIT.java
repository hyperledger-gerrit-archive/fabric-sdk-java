...
//            //SampleUser can be any implementation that implements org.hyperledger.fabric.sdk.User Interface
            ...
            testPeerServiceEventingReplay(client, replayChannel);
...
//                    }
     ...
     * retrieve the very first block .. block 0.
     *
     * @param client
    ...
    void testPeerServiceEventingReplay(HFClient client, Channel replayTestChannel) throws InvalidArgumentException, TransactionException, InterruptedException, ExecutionException, TimeoutException, ProposalException {
        ...
        replayTestChannel.addPeer(eventingPeer, PeerOptions.create().setPeerRoles(EnumSet.of(PeerRole.EVENT_SOURCE))
                .startEvents(0)); // Eventing peer start getting blocks from block 0
        ...
        replayTestChannel.registerBlockListener(block -> {
        ...
        assertEquals(replayTestChannel.queryBlockchainInfo().getHeight(), bcount.get()); //finalcount is zero based.
        assertTrue("We didn't get block 0", gotBlockZero.get()); // make sure block zero was detected.
