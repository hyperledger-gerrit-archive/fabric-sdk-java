...
public class ServiceDiscoveryIT {
    ...
    public void setup() throws Exception {
        ...
        transactionPropResp =
                foo.sendTransactionProposalToEndorsers(transactionProposalRequest, client.getUserContext(),
                        createDiscoveryOptions().ignoreEndpoints("blah.blah.blah.com:90", "blah.com:80",
                                "localhost:7051") // aka peer0.org1.example.com our discovery peer lets ignore it in discovery and see if other discoverd peer endorses.
                );
        ...
        assertEquals((testConfig.isRunningFabricTLS() ? "grpcs:" : "grpc:") + "//localhost:7056", peer.getUrl()); // not our discovery peer but the discovered one.
