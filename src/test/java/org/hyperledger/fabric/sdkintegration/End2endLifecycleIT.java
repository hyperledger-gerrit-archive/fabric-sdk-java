...
//            }
            ...
            verifyByQueryApprovalStatus(org2Client, org2Channel, org2MyPeers, definitionSequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION,
                    initRequired, chaincodeEndorsementPolicy,
            ...
            veryByQueryChaincodeDefinition(org2Channel, CHAIN_CODE_NAME, org2MyPeers, definitionSequence, initRequired);
            veryByQueryChaincodeDefinition(org1Channel, CHAIN_CODE_NAME, org1MyPeers, definitionSequence, initRequired);
    ...
    private void verifyByQueryApprovalStatus(HFClient client, Channel channel, Collection<Peer> org1MyPeers, long definitionSequence,
    ...
    private void veryByQueryChaincodeDefinition(Channel channel, String chaincodeName, Collection<Peer> peers, long expectedSequence, boolean expectedInitRequired) throws ProposalException, InvalidArgumentException {

        Collection<LifecycleQueryChaincodeDefinitionProposalResponse> queryChaincodeDefinitionProposalResponses = channel.lifecycleQueryChaincodeDefinition(chaincodeName, peers);
        ...
        for (LifecycleQueryChaincodeDefinitionProposalResponse response : queryChaincodeDefinitionProposalResponses) {
            ...
            assertTrue(validationParameter.length > 0);
