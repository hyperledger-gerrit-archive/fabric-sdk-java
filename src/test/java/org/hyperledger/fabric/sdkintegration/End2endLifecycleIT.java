...
//                    new HashSet<>(Arrays.asList("Org1MSP", "Org2MSP"))); // The unapproved.
            ...
            veryByQueryChaincodeDefinition(org2Channel, CHAIN_CODE_NAME, org2MyPeers, definitionSequence, initRequired, chaincodeEndorsementPolicyAsBytes, chaincodeCollectionConfiguration);
            veryByQueryChaincodeDefinition(org1Channel, CHAIN_CODE_NAME, org1MyPeers, definitionSequence, initRequired, chaincodeEndorsementPolicyAsBytes, chaincodeCollectionConfiguration);
    ...
    private void veryByQueryChaincodeDefinition(Channel channel, String chaincodeName, Collection<Peer> peers, long expectedSequence, boolean expectedInitRequired, byte[] expectedValidationParameter,
