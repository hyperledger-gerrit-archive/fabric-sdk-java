...
//        }
    ...
    void runChannel(HFClient org1Client, Channel org1Channel, SampleOrg org1, Collection<Peer> org1MyPeers, Collection<Peer> org1OtherPeers,
        ...
        try {
            ...
            queryLifecycleQueryChaincodeDefinitionRequest.setName(CHAIN_CODE_NAME);
            ...
            if (-1L == sequence) {
                //no not found and all error abort.
                fail("Could not get a sequence for chaincode " + CHAIN_CODE_NAME);
            }
            ...
            TransactionEvent transactionEvent = lifecycleApproveChaincodeDefinitionForMyOrg(org1Client, org1Channel,
                    ...
                    sequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION, chaincodeEndorsementPolicy, chaincodeCollectionConfiguration, initRequired, org1ChaincodePackageID)
                    .get(testConfig.getTransactionWaitTime(), TimeUnit.SECONDS);
            assertTrue(transactionEvent.isValid());

            verifyByQueryApprovalStatus(org1Client, org1Channel, sequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION,
            ...
            TransactionEvent org2TransactionEvent = lifecycleApproveChaincodeDefinitionForMyOrg(org2Client, org2Channel,
                    ...
                    sequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION, org2ChaincodeEndorsementPolicy, chaincodeCollectionConfiguration, initRequired, org2ChaincodePackageID)
                    .get(testConfig.getTransactionWaitTime(), TimeUnit.SECONDS);
            assertTrue(org2TransactionEvent.isValid());

            out("Checking on org2's network for approvals");
            verifyByQueryApprovalStatus(org2Client, org2Channel, sequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION, chaincodeEndorsementPolicy, chaincodeCollectionConfiguration, initRequired, org2MyPeers,
            ...
            verifyByQueryApprovalStatus(org1Client, org1Channel, sequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION, chaincodeEndorsementPolicy, chaincodeCollectionConfiguration, initRequired, org1MyPeers,
                    new HashSet<>(Arrays.asList("Org1MSP", "Org2MSP")), // Approved
            ...
            transactionEvent = commitChaincodeDefinitionRequest(org2Client, org2Channel, sequence, CHAIN_CODE_NAME, CHAIN_CODE_VERSION, org2ChaincodeEndorsementPolicy, chaincodeCollectionConfiguration, initRequired, org2EndorsingPeers)
                    .get(testConfig.getTransactionWaitTime(), TimeUnit.SECONDS);
            assertTrue(transactionEvent.isValid());

            out("Org2 done with commit. block #%d!", transactionEvent.getBlockEvent().getBlockNumber());

            veryByQueryChaincodeDefinition(org2Client, org2Channel, CHAIN_CODE_NAME, org2MyPeers, sequence, initRequired, chaincodeEndorsementPolicyAsBytes, chaincodeCollectionConfiguration);
            veryByQueryChaincodeDefinition(org1Client, org1Channel, CHAIN_CODE_NAME, org1MyPeers, sequence, initRequired, chaincodeEndorsementPolicyAsBytes, chaincodeCollectionConfiguration);

            verifyByQueryNamespaceDefinitions(org2Client, org2Channel, org2MyPeers, CHAIN_CODE_NAME);
            verifyByQueryNamespaceDefinitions(org1Client, org1Channel, org1MyPeers, CHAIN_CODE_NAME);
    ...
    private void verifyByQueryNamespaceDefinitions(HFClient client, Channel channel, Collection<Peer> peers, String expectChaincodeName) throws InvalidArgumentException, ProposalException {

        final LifecycleQueryNamespaceDefinitionsRequest queryNamespaceDefinitionsRequest = client.newLifecycleQueryNamespaceDefinitionsRequestRequest();

        Collection<LifecycleQueryNamespaceDefinitionsProposalResponse> lifecycleQueryNamespaceDefinitionsProposalResponses = channel.lifecycleQueryNamespaceDefinitions(queryNamespaceDefinitionsRequest, peers);
