...
//            }
            ...
            final byte[] chaincodeEndorsementPolicyAsBytes = chaincodeEndorsementPolicy.getSerializedPolicyBytes();
            ...
            veryByQueryChaincodeDefinition(org2Channel, CHAIN_CODE_NAME, org2MyPeers, definitionSequence, initRequired, chaincodeEndorsementPolicyAsBytes);
            veryByQueryChaincodeDefinition(org1Channel, CHAIN_CODE_NAME, org1MyPeers, definitionSequence, initRequired, chaincodeEndorsementPolicyAsBytes);
    ...
    private void veryByQueryChaincodeDefinition(Channel channel, String chaincodeName, Collection<Peer> peers, long expectedSequence, boolean expectedInitRequired, byte[] expectedValidationParameter) throws ProposalException, InvalidArgumentException {
    ...
    private void verifyByQueryInstalledChaincode(HFClient client, Collection<Peer> peers, String packageId, String expectedLabel) throws ProposalException, InvalidArgumentException {
        ...
        Collection<LifecycleQueryInstalledChaincodeProposalResponse> responses = client.lifecycleQueryInstalledChaincode(packageId, peers);
        assertNotNull(responses);
