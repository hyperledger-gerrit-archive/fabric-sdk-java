...
import org.hyperledger.fabric.sdk.QueryChaincodeDefinitionProposalResponse;
...
//        }
    ...
    void runChannel(HFClient org1Client, Channel org1Channel, SampleOrg org1, Collection<Peer> org1MyPeers, Collection<Peer> org1OtherPeers,
        ...
        try {
            ...
            //query definitions
            Collection<QueryChaincodeDefinitionProposalResponse> queryChaincodeDefinitionProposalResponses = org2Channel.lifecycleQueryChaincodeDefinition(CHAIN_CODE_NAME, org2MyPeers);
            ...
            for (QueryChaincodeDefinitionProposalResponse response : queryChaincodeDefinitionProposalResponses) {
