...
//            }
            ...
            byte[] chaincodeEndorsementPolicyAsBytes = chaincodeEndorsementPolicy.getSerializedPolicyBytes();
            ...
            LifecycleChaincodeEndorsementPolicy org2ChaincodeEndorsementPolicy = LifecycleChaincodeEndorsementPolicy.fromBytes(chaincodeEndorsementPolicyAsBytes);
    ...
    CompletableFuture<TransactionEvent> lifecycleApproveChaincodeDefinitionForMyOrg(HFClient client, Channel channel,
                                                                                    Collection<Peer> peers, long definitionSequence, String chaincodeName, String chaincodeVersion, LifecycleChaincodeEndorsementPolicy chaincodeEndorsementPolicy, boolean initRequired, String org1ChaincodePackageID) throws InvalidArgumentException, ProposalException {
...
//    }
    ...
    private CompletableFuture<TransactionEvent> commitChaincodeDefinitionRequest(HFClient client, Channel channel, long definitionSequence, String chaincodeName, String chaincodeVersion,
                                                                                 LifecycleChaincodeEndorsementPolicy chaincodeEndorsementPolicy, Collection<Peer> endorsingPeers, boolean initRequired) throws ProposalException, InvalidArgumentException, InterruptedException, ExecutionException, TimeoutException {
