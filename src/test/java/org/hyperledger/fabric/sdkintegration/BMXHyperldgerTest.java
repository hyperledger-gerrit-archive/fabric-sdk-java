...
public class BMXHyperldgerTest {
    ...
    static final SampleStore SAMPLE_STORE = new SampleStore(new File("BMXHyperldgerTest.Store.properties"));

    public static final String PEER_ADMIN_NAME = "admin";
    public static final String TEST_CHANNEL = "ricks-test-channel-2";
...
//    public static final String NETWORK_CONFIG_FILE = "bmxcreds_local.json";
    ...
    private void run(String[] args) throws Exception {
        ...
        // Network network = parseNetworkConfigFile(new File("bmxcreds.json"));
