            ...
            */
            ...
            chain.sendTransaction(successful, orderers).thenApply(transactionEvent -> {
                ...
                try {
                    ...
                    out("waiting <<40>> seconds to let the CC docker containers start up completely on all the peers.");
                    try {
                        // The wait time is dependent on the number of peers and how responsive each peer is.
                        // You will have to tweak this number for your environment
                        TimeUnit.SECONDS.sleep(40);
                    } catch (InterruptedException e1) {
                        fail("Should not be interrupted while we wait for the peers are bringing up the chaincode. There are no other threads going.");
                    }
