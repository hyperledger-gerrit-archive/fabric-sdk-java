...
public class End2endIT {
    ...
    void runChain(HFClient client, Chain chain, boolean installChainCode, SampleOrg orgToUse, int delta) {
        ...
        try {
            ...
            //    Set<String> orgs = orgPeers.keySet();
             //   for (SampleOrg org : testSampleOrgs) {
                    client.setUserContext(orgToUse.getAdmin());
                    Set<Peer> peersFromOrg = orgToUse.getPeers();
            ...
            */
            ...
            chain.sendTransaction(successful, orderers).thenApply(transactionEvent -> {
                ...
                try {
                    successful.clear();
                    failed.clear();
                    client.setUserContext(orgToUse.getUser("user1")); // select the user for all subsequent requests
            ...
            Set<Peer> peerSet = orgToUse.getPeers();
