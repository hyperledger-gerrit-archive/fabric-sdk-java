...
public class End2endIT {
    ...
    private Chain constructChain(String name, HFClient client, SampleOrg sampleOrg) throws Exception {
        ...
        cp.init();
        Certificate cert = cp.bytesToCertificate(cb);



        SampleUser.AfakeEnrollmentImplementation enrollment = new SampleUser.AfakeEnrollmentImplementation("xxx", null, new String(cb, "UTF-8"));
