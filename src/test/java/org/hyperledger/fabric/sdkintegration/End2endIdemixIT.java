...
public class End2endIdemixIT extends End2endIT {
    ...
    private static final String IDEMIX_USER = "idemixUser";
    ...
    public void enrollIdemixUser(SampleStore sampleStore) throws Exception {
        for (SampleOrg sampleOrg : testSampleOrgs) {
            ...
            SampleUser admin = sampleStore.getMember(TEST_ADMIN_NAME, orgName);
            SampleUser idemixUser = sampleStore.getMember(IDEMIX_USER, sampleOrg.getName());
            ...
            if (testConfig.isFabricVersionAtOrAfter("1.3")) {
                idemixUser.setIdemixEnrollment(ca.idemixEnroll(idemixUser.getEnrollment(), "idemixMSPID"));
            }
