...
public class NetworkConfigIT {
    ...
    private static void doInitialSetup() throws Exception {
        ...
        if (!checkInstalledChaincode(client, chaincodeName, CHAIN_CODE_PATH, CHAIN_CODE_VERSION)) {
            ...
            SampleOrg sampleOrg = testConfig.getIntegrationTestsSampleOrg("peerOrg1");
            deployChaincode(client, fooChannel, sampleOrg, chaincodeName);
        }
    ...
    private static ChaincodeID deployChaincode(HFClient client, Channel channel, SampleOrg sampleOrg, String chaincodeName) {
