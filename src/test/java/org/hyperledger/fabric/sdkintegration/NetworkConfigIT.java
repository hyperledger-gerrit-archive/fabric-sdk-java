...
public class NetworkConfigIT {
    ...
    private static Map<String, User> orgReginsteredUsers = new HashMap<>();
    ...
    public static void doMainSetup() throws Exception {
        ...
        orgReginsteredUsers.put(org.getName(), mockuser);
    ...
    public void testUpdate1() throws Exception {
        ...
        client.setUserContext(orgReginsteredUsers.get("Org1")); // only using org1
