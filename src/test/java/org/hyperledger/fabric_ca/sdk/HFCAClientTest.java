...
public class HFCAClientTest {
    ...
    @Test
    public void testSetCryptoSuiteInvalidCertificate() throws Exception {

        thrown.expect(CryptoException.class);
        thrown.expectMessage("Cannot initialize");

        String previousCertFormat = TestUtils.setConfigProperty(Config.CERTIFICATE_FORMAT, "abc123");
        ...
        try {
            ...
            TestUtils.setConfigProperty(Config.CERTIFICATE_FORMAT, previousCertFormat);
        }
    }
