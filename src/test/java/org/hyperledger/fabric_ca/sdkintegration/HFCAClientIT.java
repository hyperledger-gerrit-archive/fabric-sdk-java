...
public class HFCAClientIT {
    ...
    public void testUserRevoke() throws Exception {
        ...
        if (!user.isRegistered()) {
            ...
            rr.addAttribute(new Attribute(HFCAClient.HFCA_HFREVOKER, "true"));
    ...
    public void testCreateAndGetIdentity() throws Exception {
        ...
        HFCAIdentity ident = getIdentityReq("testuser1", HFCAClient.HFCA_PEER);
        ident.create(admin);
    ...
    public void testGetAllIdentity() throws Exception {
        ...
        HFCAIdentity ident = getIdentityReq("testuser2", HFCAClient.HFCA_CLIENT);
        ident.create(admin);
    ...
    public void testModifyIdentity() throws Exception {
        ...
        HFCAIdentity ident = getIdentityReq("testuser3", HFCAClient.HFCA_ORDERER);
        ident.create(admin);
