...
public class HFCAClientIT {
    ...
    public void testUserRevokeNoReasonWithCRL() throws Exception {
        ...
        if (!testConfig.isRunningAgainstFabric10()) {
            ...
            final int crlLength = getRevokes(null, crl).length;
            ...
            String crl2 = client.revoke(admin, user1.getName(), null, false);
    ...
    TBSCertList.CRLEntry[] getRevokes(Date r) throws Exception {
        ...
        return getRevokes(r, crl);
    }

    TBSCertList.CRLEntry[] getRevokes(Date r, String crl) throws Exception {
