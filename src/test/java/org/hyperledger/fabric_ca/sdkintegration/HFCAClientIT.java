...
//            assertEquals(format("Expected same revocations %d, but got %d", startedWithRevokes, revokestinybitago), startedWithRevokes, revokestinybitago);
    ...
    public void testGetCertificates() throws Exception {
        ...
        HFCACertificate certReq = client.newHFCACertificate();
        ...
        HFCACertificate.HFCACertificateResponse resp = certReq.read(admin2);
    ...
    private X509Certificate getCert(Collection<String> certs, int index) throws CertificateException {
        String[] certStr = certs.toArray(new String[certs.size()]);
        return getCert(certStr[index].getBytes());
    }
