...
rm -rf target
mvn -B clean install -U -DskipITs=false -Dmaven.test.failure.ignore=false -Djdk.net.URLClassPath.disableClassPathURLCheck=true javadoc:javadoc ${ORG_HYPERLEDGER_FABRIC_SDKTEST_ITSUITE}
